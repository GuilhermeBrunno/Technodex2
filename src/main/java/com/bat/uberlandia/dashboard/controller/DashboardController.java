...
public class DashboardController {
    ...
    public String dashboard(
        ...
        for (TendenciaDiaria t : tendencia) {
            if (t != null && t.getDia() != null) {
                tendenciaMap.put(t.getDia().toString(), t.getTotal() != null ? t.getTotal() : 0L);
            }
        }
        ...
        for (TendenciaMotivoDiaria t : tendenciaMotivo) {
            if (t != null && t.getMotivo() != null && t.getDia() != null) {
                tendenciaMotivoMap
                        .computeIfAbsent(t.getMotivo().name(), k -> new LinkedHashMap<>())
                        .put(t.getDia().toString(), t.getTotal() != null ? t.getTotal() : 0L);
            }
        }
